...
import { DecimalValidator } from '../../core/validators/DecimalValidator';
...
export default class OrderFormComponent {
  ...
  public form = this.builder.group({
    ...
    Freight: [, [Validators.required, Validators.min(0), DecimalValidator(3, 2)]],
    ProductId: [, Validators.required],
    UnitPrice: [, [Validators.required, Validators.min(0), DecimalValidator(3, 2)]],
    Quantity: [, [Validators.required, Validators.min(0), Validators.max(999)]],
    Discount: [, [Validators.required, Validators.min(0), DecimalValidator(1, 3)]],
